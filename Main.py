...
def startprint():
    ...
    print(f'''{Fore.RESET}
{Fore.CYAN}Version {SELFBOT.__version__} | {Fore.GREEN}Logged in as: {Alucard.user.name}#{Alucard.user.discriminator} {Fore.CYAN}| ID: {Fore.GREEN}{Alucard.user.id}   
...
{Fore.CYAN}Join: {Fore.GREEN} https://discord.gg/ncKteVXG
{Fore.CYAN}Cracked by: Bro#0003
